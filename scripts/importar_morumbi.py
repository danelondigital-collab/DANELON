"""
Importação completa das comandas de Morumbi
Fontes:
  - Vendas-Comandas-Pacotes2018-2026 Morumbi.xls  (cabeçalho das comandas)
  - Vendas-Produtos-Serviços-Completo 2018-2026 Morumbi.xls (itens + profissionais)
"""
...
SA_UNIDADE   = "7649a21a-2018-4758-960c-fe56041cfbc8"
...
wb_totais = xlrd.open_workbook("/Users/jorgesouza/Documents/Claude/Projects/DANALON/danelon-app/scripts/Vendas-Comandas-Pacotes2018-2026 Morumbi.xls")
ws_totais = wb_totais.sheet_by_index(0)

wb_itens = xlrd.open_workbook("/Users/jorgesouza/Documents/Claude/Projects/DANALON/danelon-app/scripts/Vendas-Produtos-Serviços-Completo 2018-2026 Morumbi.xls")
...
if erros_log:
    with open("/tmp/erros_importacao_morumbi.txt", "w") as f:
        f.write("\n".join(erros_log))
    print(f"\n  Log de erros salvo em /tmp/erros_importacao_morumbi.txt")
